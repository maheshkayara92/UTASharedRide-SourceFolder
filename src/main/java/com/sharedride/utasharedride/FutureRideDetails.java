 ...
 */
public class FutureRideDetails extends AppCompatActivity {
    ListView lv;
    Model[] modelItems;
    ...
    public void invokeWS(final Context c){
        ...
        client.get("http://10.4.100.9:8080/SharedRide/futurerides/dofuturerides", params, new JsonHttpResponseHandler() {
            @Override
